...
class _HomeScreenState extends State<HomeScreen> {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(AppConstant.homeScreenTitle, style: TextStyle(color: AppColors.appBarTitleColor, fontSize: 18.sp, fontWeight: FontWeight.w600)),
          ),
        drawer: Drawer(
 ...
 Future<void> _showAlertDialog() async {
  ...
  getNativeAdTest({required BuildContext context}) {}
    ...
    return Column(
      ...
      child: Column(
        children: [
          ...
          Text(AppConstant.appName, style: TextStyle(color: AppColors.appBarTitleColor, fontSize: 18.sp, fontWeight: FontWeight.w600)),
        ],
      ),
    ),
        ListTile(
